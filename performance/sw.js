/* Performance & Queueing Bootcamp service worker — offline-first app shell.
...
const SHELL = [
  ...
  "./js/packs/10-lessons-tail.js",
  "./js/packs/20-lessons-load.js",
  "./js/packs/30-lessons-measure.js",
  "./js/packs/40-lessons-capacity.js",
  "./js/packs/50-hunt-build.js",
  "./js/packs/60-production-map.js",
  "../js/app.js",
  "../js/account.js",
];
