  ...
  { eb:"lesson 14 · indexing", title:"Predicates that can't use the index", html:`
    ...
    <div class="diagram anim" style="--step:.7s">
      ...
      <div class="lanes">
        ...
        <div class="lanehead seq" style="--i:3">type mismatch</div><div class="lstep bad seq" style="--i:3">varchar_col = 123, or a text parameter against an int column &mdash; the cast lands on the COLUMN and defeats the index (some engines silently cast every row)</div>
