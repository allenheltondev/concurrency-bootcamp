/* Database Internals Bootcamp service worker — offline-first app shell.
...
const SHELL = [
  ...
  "./js/packs/10-lessons-storage.js",
  "./js/packs/20-lessons-indexing.js",
  "./js/packs/30-lessons-transactions.js",
  "./js/packs/40-lessons-operations.js",
  "./js/packs/50-hunt-build.js",
  "./js/packs/60-postgres-map.js",
  "../js/app.js",
  "../js/account.js",
